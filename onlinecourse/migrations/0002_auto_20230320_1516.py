# Generated by Django 3.1.3 on 2023-03-20 15:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(default='text', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_txt', models.CharField(default='text', max_length=100)),
